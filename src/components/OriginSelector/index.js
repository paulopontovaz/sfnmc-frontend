...
const OriginSelector = () => {
  ...
  return (
    <div className="origin-selector">
      <form onSubmit={handleSubmit(onSubmit)} className="origin-selector-form">
        <div className="origin-selector-input-container">
          <label className="origin-selector-label" htmlFor="origin_name">
            Saindo de
          </label>
          <input
          ...
          <datalist id="origin-list">
            {["Chocolate", "Coconut", "MUC", "Strawberry", "Vanilla"].map(
              (item) => (
          ...
          {errors.exampleRequired && (
            <span className="origin-selector-error">Campo obrigatório</span>
          )}
        </div>
